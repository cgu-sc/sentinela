...
def _matriz_risco_schema() -> dict:
    return {
        ...
        "auditado_total_caixas_sem_comprovacao": pl.Int64,
        "auditado_total_autorizacoes": pl.Int64,
        "pct_auditado": pl.Float64,
        "falecidos_total_autorizacoes": pl.Int32,
        "falecidos_qtd_autorizacoes": pl.Int32,
        "falecidos_valor_total": pl.Float64,
        "falecidos_valor": pl.Float64,
        "pct_falecidos": pl.Float64,
        ...
        "polimedicamento_valor_total": pl.Float64,
        "polimedicamento_valor": pl.Float64,
        "pct_polimedicamento": pl.Float64,
        "ticket_valor_total": pl.Float64,
        "ticket_total_autorizacoes": pl.Int64,
        "val_ticket_medio": pl.Float64,
        "receita_paciente_valor_total": pl.Float64,
        "receita_paciente_total_pacientes_distintos": pl.Int32,
        "receita_paciente_total_meses_ativos": pl.Int32,
        "val_receita_paciente": pl.Float64,
        "per_capita_valor_total": pl.Float64,
        "per_capita_total_meses_ativos": pl.Int32,
        "per_capita_populacao_municipio": pl.Int32,
        "per_capita_denominador": pl.Int64,
        "val_per_capita": pl.Float64,
        "vendas_rapidas_total_intervalos": pl.Int32,
        "vendas_rapidas_total": pl.Int32,
        "vendas_rapidas_valor_total": pl.Float64,
        "vendas_rapidas_valor": pl.Float64,
        "pct_vendas_rapidas": pl.Float64,
        "volume_atipico_total_semestres_comparaveis": pl.Int32,
        "volume_atipico_total_semestres_atipicos": pl.Int32,
        ...
        "pct_geografico": pl.Float64,
        "alto_custo_valor_total": pl.Float64,
        "alto_custo_valor": pl.Float64,
        "pct_alto_custo": pl.Float64,
        "pico_valor_total": pl.Float64,
        "pico_valor_top3_dias": pl.Float64,
        "pct_pico": pl.Float64,
        "hhi_total_prescritores": pl.Int32,
        "hhi_total_prescricoes": pl.Int64,
        ...
        "crms_irregulares_total_prescricoes": pl.Int64,
        ...
        "pct_crms_irregulares": pl.Float64,
        ...
        "pct_recorrencia_sistemica": pl.Float64,
    }
