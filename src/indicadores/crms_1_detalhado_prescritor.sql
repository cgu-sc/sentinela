...
-- Criamos um índice para o crms_2 usar depois
CREATE CLUSTERED INDEX IDX_BaseAgreg_Key ON temp_CGUSC.fp.base_agregada_crm_cnpj(nu_cnpj, nu_crm);
...
PRINT '>> Processando Alerta 5 (Geográfico)...';
    ...
    PairedWithDistance AS (
        SELECT
            ...
            -- SÓ CHAMA A FUNÇÃO PESADA SE O MÉDICO ESTIVER EM ESTADOS DIFERENTES OU MUNICÍPIOS DISTANTES
            CASE 
