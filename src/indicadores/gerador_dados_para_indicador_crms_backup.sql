-- ============================================================================
-- GERADOR DE DADOS PARA INDICADOR DE CRMs - VERSÃO CORRIGIDA
-- ============================================================================
-- CORREÇÕES APLICADAS:
...
INNER JOIN temp_CGUSC.dbo.tb_uf_crm D ON D.uf = A.sg_uf_crm
...
SET alerta1 = 'Número de CRM Inválido.'
WHERE nu_crm > nu_max_crm
...
PRINT '  - Todos os alertas (1-5) populados corretamente';
PRINT '============================================================================';
GO