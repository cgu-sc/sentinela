...
CRM_PERFIL_DIARIO_PARQUET = _module("crm_perfil_diario")
CRM_HORARIO_PARQUET = _module("crm_horario")
CRM_HORARIO_EVENTOS_PARQUET = _module("crm_horario_eventos")
...
MEDIANA_AUTORIZACOES_HORARIA_PARQUET = _module("mediana_autorizacoes_horaria")
MEDIANA_AUTORIZACOES_HORARIA_MOVEL_PARQUET = _module("mediana_autorizacoes_horaria_movel")
