...
<template>
  <div class="update-blocker">
    <div class="update-blocker__card">
      <div class="update-blocker__icon-wrap">
        <svg class="update-blocker__icon" viewBox="0 0 24 24" fill="none"
      ...
      <h1 class="update-blocker__title">Atualização obrigatória</h1>
      <p class="update-blocker__subtitle">
        Esta versão do Sentinela não é mais suportada e precisa ser atualizada para continuar.
      </p>
      ...
      <div class="update-blocker__actions">
        <button class="update-action update-action--primary" @click="openDownload">
        ...
        <button class="update-action update-action--secondary" @click="openChangelog">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round" width="16" height="16">
        ...
        <button v-if="isDesktop()" class="update-action update-action--ghost" @click="exitApp">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round" width="16" height="16">
