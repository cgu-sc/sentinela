...
CREATE NONCLUSTERED INDEX IDX_FinalMedia_Risco ON temp_CGUSC.fp.indicador_media_itens_detalhado(risco_relativo_uf DESC);
GO

-- Verificação rápida
SELECT TOP 100 * FROM temp_CGUSC.fp.indicador_media_itens_detalhado ORDER BY risco_relativo_uf DESC;
