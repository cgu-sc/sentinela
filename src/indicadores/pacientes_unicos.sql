...
-- ============================================================================
DROP TABLE IF EXISTS temp_CGUSC.dbo.indicadorPacientesFantasma;
...
INTO temp_CGUSC.dbo.indicadorPacientesFantasma
FROM #RecorrenciaPorCPF
GROUP BY cnpj;

CREATE CLUSTERED INDEX IDX_IndFantasma_CNPJ ON temp_CGUSC.dbo.indicadorPacientesFantasma(cnpj);
...
-- ============================================================================
DROP TABLE IF EXISTS temp_CGUSC.dbo.indicadorPacientesFantasma_UF;
...
INTO temp_CGUSC.dbo.indicadorPacientesFantasma_UF
FROM temp_CGUSC.dbo.indicadorPacientesFantasma I
INNER JOIN temp_CGUSC.dbo.dadosFarmaciasFP F 
    ON F.cnpj = I.cnpj
GROUP BY CAST(F.uf AS VARCHAR(2));

CREATE CLUSTERED INDEX IDX_IndFantasmaUF_UF ON temp_CGUSC.dbo.indicadorPacientesFantasma_UF(uf);
...
-- ============================================================================
DROP TABLE IF EXISTS temp_CGUSC.dbo.indicadorPacientesFantasma_BR;
...
INTO temp_CGUSC.dbo.indicadorPacientesFantasma_BR
FROM temp_CGUSC.dbo.indicadorPacientesFantasma;


-- ============================================================================
-- PASSO 5: TABELA CONSOLIDADA FINAL (COMPARATIVO DE RISCO)
-- ============================================================================
DROP TABLE IF EXISTS temp_CGUSC.dbo.indicadorPacientesUnicos_Completo;
...
INTO temp_CGUSC.dbo.indicadorPacientesUnicos_Completo
FROM temp_CGUSC.dbo.indicadorPacientesFantasma I
INNER JOIN temp_CGUSC.dbo.dadosFarmaciasFP F 
    ON F.cnpj = I.cnpj
LEFT JOIN temp_CGUSC.dbo.indicadorPacientesFantasma_UF UF 
    ON CAST(F.uf AS VARCHAR(2)) = UF.uf
CROSS JOIN temp_CGUSC.dbo.indicadorPacientesFantasma_BR BR;

-- Índices Finais
CREATE CLUSTERED INDEX IDX_FinalFantasma_CNPJ ON temp_CGUSC.dbo.indicadorPacientesUnicos_Completo(cnpj);
CREATE NONCLUSTERED INDEX IDX_FinalFantasma_Risco ON temp_CGUSC.dbo.indicadorPacientesUnicos_Completo(risco_relativo_uf DESC);
GO
-- ============================================================================
-- VERIFICAÇÃO E ESTATÍSTICAS
-- ============================================================================
SELECT TOP 100 * 
FROM temp_CGUSC.dbo.indicadorPacientesUnicos_Completo 
