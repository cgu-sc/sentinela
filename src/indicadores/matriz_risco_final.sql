    ...
    SELECT 
        *,
        CASE 
            ...
            WHEN qtd_indicadores_criticos >= 3 THEN 'RISCO CRÍTICO'
            ...
            WHEN qtd_indicadores_criticos = 1 THEN 'RISCO MÉDIO'
            WHEN SCORE_RISCO_FINAL >= 2.0 THEN 'RISCO MÉDIO'
...
select top 100 *  FROM temp_CGUSC.dbo.Matriz_Risco_Final where municipio = 'Florianópolis' 
